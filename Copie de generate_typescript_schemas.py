'''
Script pour générer les schémas TypeScript à partir des datasets.
'''

typescript_schemas = '''// types/database.ts
...
output_path = "/home/ubuntu/pregnancy-app-datasets/architecture/"
with open(output_path + "database.ts", 'w', encoding='utf-8') as f:
    f.write(typescript_schemas)

print("✅ Schémas TypeScript générés avec succès !")
print(f"Fichier : {output_path}database.ts")
